...
### Created by Peter Forret ( pforret ) on 2022-04-24
### Based on https://github.com/pforret/bashew 1.17.0
script_version="0.0.1" # if there is a VERSION.md in this script's folder, it will take priority for version number
readonly script_author="peter@forret.com"
readonly script_created="2022-04-24"
...
show_usage() {
  ...
  out "Description: Wikipedia CLI in bash"
